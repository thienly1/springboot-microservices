      ...
      <div>
        <div className='container col-md-6 card offset-md-3'>
            ...
            <div className='card-body'>
                ...
                <div className='row'>
                    <p><strong>Department Descriptiom: </strong> {this.state.department.departmentDescription}</p>
                </div>
                <div className='row'>
            ...
            <div className='card-body'>
                ...
                <div className='row'>
                    <p><strong>Organization Descriptiom: </strong> {this.state.organization.organizationDescription}</p>
                </div>
                <div className='row'>
